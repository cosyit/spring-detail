...
import day_02.constant.RoutingVersionConstant;
...
public class RoutingBeanProxyFactory {
    ...
    static class VersionRoutingMethodInterceptor implements MethodInterceptor {
        ...
        //把单独的事情，用一个方法来代替。这种设计还是比较好的。以后要多用。业务抽离，用方法名来代替了注释。
        ...
        public Object getTargetBean(String switchName) {
            boolean switchOn;
            if (RoutingVersionConstant.A.equals(switchName)) {
                switchOn = false;
            } else if (RoutingVersionConstant.B.equals(switchName)) {
                switchOn = true;
            } else {
                switchOn =  true; //FunctionSwitch.isSwitchOpened(switchName);
            }
